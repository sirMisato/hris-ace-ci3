...
<section>
	...
	<p> Use this link to go to initiate page <a href="<?php echo base_url('')?>/admin/dashboard"
			target="_blank">Admin/Dashboard</a>	</p>

	<p>If you would like to edit Admin/Dashboard page you will find it located at:</p>

	<pre><code>app/Views/admin/home.php</code></pre>

	<p>The corresponding controller for Admin/Dashboard page can be found at:</p>

	<pre><code>app/Controllers/Admin/Dashboard.php</code></pre>

	<p>If you want to see another HTML example just go to:</p>

	<pre><code>app/Template/Ace</code></pre>
